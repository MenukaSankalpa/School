...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body { font-family: 'Poppins', sans-serif; background-color: #f4f6f8; display: flex; color: #2c3e50; }
        .sidebar { width: 240px; background-color: #1e293b; color: white; height: 100vh; position: fixed; padding: 30px 20px; }
        .sidebar h2 { font-size: 22px; margin-bottom: 40px; text-align: center; font-weight: 600; }
        .sidebar a { display: flex; align-items: center; gap: 10px; padding: 12px 16px; color: white; text-decoration: none; border-radius: 6px; transition: background 0.3s; font-size: 16px; }
...
<div class="sidebar">
    ...
    <a href="layout.php?page=communication_records"><span class="material-icons">forum</span>Communication Logs</a>
